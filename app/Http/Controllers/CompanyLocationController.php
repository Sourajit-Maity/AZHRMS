...
class CompanyLocationController extends Controller
{
    ...
    public function submitcompanylocation(Request $request)
   {
    ...
    CompanyLocation::create([
       ...
       return Redirect::to('view-company-location')->with('success',' Created Successfully!');
   }
   ...
   public function viewcompanylocation(Request $request)
   {
       ...
       $companylocation = DB::table('azhrms_company_location')
       ->select('l_name','operational_company_id','azhrms_company_location.id as id','azhrms_company_gen_info.id as c_id','azhrms_company_gen_info.c_name','address','zip_code','phone','fax','district','city')
   ...
   public function editcompanylocation($id)
   {
    ...
    $editlocation= DB::table('azhrms_company_location')->select('azhrms_company_gen_info.c_name as company_name','azhrms_company_location.operational_company_id as company_id')->
    join('azhrms_company_gen_info', 'azhrms_company_location.operational_company_id', '=', 'azhrms_company_gen_info.id')
    ->where('azhrms_company_location.id',$id)->get();
    //$company1= DB::table('azhrms_company_gen_info')->where('id',$id)->get();
 

     return view('company.editcompanylocation',compact('company','editdistrict','editlocation','state','district','location'));
   }
    ...
    public function viewlocation($id,Request $request)
   {
       ...
       $companylocation = CompanyLocation::where('operational_company_id',$id)->get();
