                ...
                <div class="card-body">
                    <form method="PUT" action="{{ route('submit_leave_entitlement') }}">
                        ...
                        <div class="form-group row" >
                            ...
                            <div class="col-md-6">
                            <select  name="company_id" id="company_id" class="form-control"  value="{{ old('company_id') }}" autocomplete="company_id" >
                        ...
                        <div class="form-group row">
                            <label for="leave_type_id" class="col-md-4 col-form-label text-md-right">{{ __('Leave Type') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="period" class="col-md-4 col-form-label text-md-right">{{ __('Leave Period') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="no_of_days" class="col-md-4 col-form-label text-md-right">{{ __('Entitlement') }}</label>

                            <div class="col-md-6">
                                <input id="no_of_days" type="text" class="form-control @error('no_of_days') is-invalid @enderror" name="no_of_days" value="{{ old('no_of_days') }}" required autocomplete="no_of_days" autofocus>
