                ...
                <div class="card-body">
                    <form method="PUT" action="{{ route('update-leave-entitlement', $leaveentitlement->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="no_of_days" type="text" class="form-control @error('no_of_days') is-invalid @enderror" name="no_of_days" value="{{ $leaveentitlement->no_of_days }}" required autocomplete="no_of_days" autofocus>
