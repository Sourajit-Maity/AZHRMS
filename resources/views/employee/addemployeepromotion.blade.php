            ...
            <div class="card">
                ...
                <form  action="{{ route('submit_employee_promotion', $promotion->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="last_designation" type="text" class="form-control @error('last_designation') is-invalid @enderror" name="last_designation"  required autocomplete="last_designation" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="last_salary" type="number" class="form-control @error('last_salary') is-invalid @enderror" name="last_salary"  required autocomplete="last_salary" autofocus>
