...
<div class="container">
<div class="tab">
<button class="tablinks" onclick="openCity(event, 'London')">Info 1</button>
  <button class="tablinks" onclick="openCity(event, 'Paris')">Info 2</button>
  <button class="tablinks" onclick="openCity(event, 'Tokyo')">Info 3</button>
  <button class="tablinks" onclick="openCity(event, 'Kolkata')">Info 4</button>
  <button class="tablinks" onclick="openCity(event, 'Delhi')">Info 5</button>
</div>
